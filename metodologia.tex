La investigación se basó en una metodología experimental de dos fases, cada una con propósitos específicos: Fase 1 (pruebas de validación) para evaluar sistemáticamente el impacto de la BS sobre la estimación de distancia punto a punto en múltiples ubicaciones corporales; Fase 2 (pruebas de desempeño) para evaluar el desempeño del sistema de posicionamiento 2D completo utilizando los modelos estadísticos derivados de Fase 1.
...
\begin{figure}[H]
    ...
    \caption{Croquis del escenario experimental Fase 2: distribución de anclas fijas y trayectoria de 18 puntos; las flechas indican la dirección del sujeto de prueba.}
    \label{fig:croquis}
\end{figure}
