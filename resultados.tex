...
Basado en estos hallazgos, se propone un \textbf{Factor de Peso} para algoritmos de localización ponderados, definido como la relación de desviaciones estándar $\sigma_{LOS}/\sigma_{NLOS} \approx 0.28$. Este valor sugiere que una medición NLOS debería tener aproximadamente un tercio del peso de una medición limpia en el cálculo de la posición.
