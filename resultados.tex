...
\subsubsection{Comparación: Pecho y Contraste con Cabeza}
...
En contraste, cuando analizamos hipotéticamente una ubicación como la cabeza (no presentada aquí pero predicha por Fase 1), donde la atenuación NLOS es moderada (MAE: 18.16~cm interior), el sesgo sería mucho menor. En tal caso, el EKF sí convergería cercano a la posición verdadera, demostrando que el sistema es robusto CUANDO la visibilidad de línea de vista es suficiente.
